...
namespace Blog.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> PostComment([Bind("PostID,CommentBody,CommentDate,CommentAuthor")] Comment comment)
        {
            if (ModelState.IsValid)
            {
                ...
                // //else post.CommentList.Add(comment);
                //await Details(comment.PostID);
            }
            else return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditComment(int id, [Bind("ID,PostID,CommentBody,CommentDate,CommentAuthor")] Comment comment)
        {
            {
                if (id != comment.ID)
                {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("ID,Body,Category,Date,Title, Author")] Post post)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Date,Author,Body,Category,Title,CommentList")] Post post)
        {
            if (id != post.ID)
            {
                return NotFound();
